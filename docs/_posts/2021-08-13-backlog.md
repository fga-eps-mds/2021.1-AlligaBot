...
## Histórico de revisão
  ...
  |18/10/2021|1.1|Adição de uma US alterando a US44|Thaís Rebouças|
...
|US43|Eu, como usuário com suspeita de covid, desejo saber qual tipo de exame devo fazer|Must| 5 |
|US44|Eu, como usuário, desejo saber quais são os tipos de exames e para qual situação são realizados |Must| 3 |
|US45|Eu, como usuário, testei positivo para covid e quero saber o que fazer|Must| 3 |
...
|ID|User Story|Prioridade|Pontos|
|----------|-----------|---------|---------|
|US46|Eu, como usuário, desejo cadastrar a data da próxima dose da vacina|Must| 8 |
|US47|Eu, como usuário, desejo ser lembrado da próxima dose da vacina|Must| 8 |

#### FT11: Avisos e cuidados

|ID|User Story|Prioridade|Pontos|
|----------|-----------|---------|---------|
|US48|Eu, como usuário, desejo cadastrar interesse em receber mensagens sobre as principais descobertas sobre a covid|Could| 8 |
|US49|Eu, como usuário, desejo ser notificado sobre as principais descobertas sobre a covid|Could|  8 |
|US50|Eu, como usuário, desejo cadastrar interesse em receber mensagens sobre dicas de home office|Could| 8 |
|US51|Eu, como usuário, desejo receber dicas de home office|Could| 8 |
|US52|Eu, como usuário, desejo cadastrar interesse em receber mensagens sobre dicas de saúde mental|Should| 8 |
|US53|Eu, como usuário, desejo receber dicas de saúde mental|Should| 8 |

...
class ResponderQuantidadeMortosPorPeriodoAction(Action):
    ...
    def run(
        ...
        # Realiza a soma de todos os casos de mortes naquele dia em todas as cidades
        total_mortos_por_periodo_no_brasil = dataframe_data['newDeaths'].sum()
